...
const RoadMapGraphicQ3: FC<RoadMap> = ({ handleClick, visible = false }) => {
  return (
    <div
      className={`${visible ? "block" : "hidden"} ${
        styles.roadmap__svg__container
    ...
    >
      <h1 className={styles.roadmap__svg__head}>
        Plans for <GreenText>Q3</GreenText>
      </h1>
      <svg
        clipRule="evenodd"
        fillRule="evenodd"
      ...
      >
        <g transform="translate(447.86 -.496)">
          ...
          <g transform="translate(-22.79 -2.122)" clipPath="url(#a)">
            <text
              ...
              transform="translate(-21.008 1.938)"
            >
              <tspan x={226.182} y={48.597}>
                {"strategic"}
              </tspan>
              <tspan x={226.182} y={73.597}>
                {"partnerships"}
              </tspan>
            </text>
          </g>
        ...
        <text
          ...
          transform="translate(-21.008 1.938)"
        >
          <tspan x={197.049} y={48.597}>
            {"dapp continuous"}
          </tspan>
          <tspan x={197.049} y={73.597}>
            {"release schedule"}
          </tspan>
        </text>
        <path
        ...
        <g transform="translate(-34.151 2.238)" clipPath="url(#b)">
          <text
            ...
            strokeWidth={1.089}
          >
            <tspan x={247.52} y={44.396}>
              <tspan>{"alternative "}</tspan>
            </tspan>
            <tspan x={247.52} y={70.068}>
              <tspan>{"contract support"}</tspan>
            </tspan>
          </text>
        </g>
        <g transform="translate(446.47)">
        ...
        <text
          ...
          xmlSpace="preserve"
          className={`${styles.roadmap__svg_nav_text}`}
          onClick={() => handleClick(0)}
        >
          <tspan x={-1.391} y={190.416}>
            {"<<Q2"}
          </tspan>
        </text>
        <text
...
const RoadMapGraphicQ4: FC<RoadMap> = ({ handleClick, visible = false }) => {
  return (
    <div
      className={`${visible ? "block" : "hidden"} ${
        styles.roadmap__svg__container
    ...
    >
      <h1 className={styles.roadmap__svg__head}>
        Plans for <GreenText>Q4</GreenText>
      </h1>
      <svg
        clipRule="evenodd"
        fillRule="evenodd"
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g transform="matrix(1.4177 0 0 1 708.82 -.496)">
          <path
            d="M382 0v95.677L369.611 108h-213.61V12.311L168.377 0z"
            fill="#ed1c24"
            fillRule="nonzero"
          />
          <clipPath id="a">
        ...
        <text
          ...
          fontSize={18.667}
          className={styles.roadmap__svg_text}
          transform="translate(867.52 3.941)"
        >
          <tspan x={81.905} y={56.098}>
            {"nft staking and use case"}
          </tspan>
        </text>
        <path
          d="M839.67 148v96.108l-17.463 12.365h-301.4v-96.096L538.27 148z"
          fill="#ed1c24"
          fillRule="nonzero"
        />
        <text
          ...
          y={32.905}
          fontSize={18.667}
          transform="translate(459 152.3)"
          className={styles.roadmap__svg_text}
        >
          <tspan x={107.555} y={56.471}>
            {"shonen nft collection"}
          </tspan>
        </text>
        <path
          d="M239.93 128.53H33.3v-1h206.22L260.05 107l.71.71-20.83 20.82zM1067.79 128.034H861.16v-1h206.22l20.53-20.53.71.71z"
          fill="#ed1c24"
          fillRule="nonzero"
        />
        <path
        ...
        />
        <path
          d="M656.24 137.41a9.38 9.38 0 1 0-.001-18.761 9.38 9.38 0 0 0 .001 18.761z"
          fill="#ed1c24"
          fillRule="nonzero"
        />
        <g fill="#ed1c24">
          <g fillRule="nonzero">
            <path d="M29.51 132.56a4.514 4.514 0 0 1-4.171-2.801 4.521 4.521 0 0 1 5.927-5.888 4.524 4.524 0 0 1 2.774 4.189 4.532 4.532 0 0 1-4.53 4.5zm0-8a3.519 3.519 0 0 0-2.468 6.02 3.513 3.513 0 0 0 3.841.746 3.518 3.518 0 0 0 2.157-3.266 3.528 3.528 0 0 0-2.177-3.27 3.532 3.532 0 0 0-1.353-.27v.04zM1351.3 132.56c-.89 0-1.77-.266-2.51-.762a4.607 4.607 0 0 1-1.67-2.029 4.487 4.487 0 0 1-.25-2.611c.17-.877.6-1.682 1.23-2.315a4.528 4.528 0 0 1 6.96.685 4.51 4.51 0 0 1-.57 5.705 4.509 4.509 0 0 1-3.19 1.327zm0-8c-.7 0-1.38.206-1.96.593-.57.387-1.03.936-1.29 1.579a3.458 3.458 0 0 0-.2 2.034c.13.683.47 1.31.96 1.803a3.518 3.518 0 0 0 3.84.763 3.56 3.56 0 0 0 1.58-1.297 3.57 3.57 0 0 0 .59-1.955c0-.466-.08-.927-.26-1.358a3.4 3.4 0 0 0-.76-1.154 3.57 3.57 0 0 0-1.15-.774c-.42-.18-.88-.273-1.35-.274v.04zM241.4 132.05a4.02 4.02 0 1 0 0-8.04 4.02 4.02 0 0 0 0 8.04zM1067.7 132.05a4.02 4.02 0 1 0 0-8.04 4.02 4.02 0 0 0 0 8.04zM677.38 149.07l-20.53-20.54H387.28v-1h269.98l20.83 20.83z" />
          </g>
          <text
            x={-1.391}
            y={174.416}
        ...
        >
          <tspan x={1265.206} y={190.416}>
            {">>>"}
          </tspan>
        </text>
        <path
          d="M385.524 1.83v96.108l-13.343 12.365H141.877V14.207L155.22 1.83z"
          fill="#ed1c24"
          fillRule="nonzero"
        />
        <text
...
const RoadMapGraphic2023: FC<RoadMap> = ({ handleClick, visible = false }) => {
  return (
    <div
      className={`${visible ? "block" : "hidden"} ${
        styles.roadmap__svg__container
    ...
    >
      <h1 className={styles.roadmap__svg__head}>
        Plans for <GreenText>2023</GreenText>
      </h1>
      <svg
        clipRule="evenodd"
        fillRule="evenodd"
      ...
      >
        <g fill="#ed1c24">
          <path
            d="M239.93 128.53H33.3v-1h206.22L260.05 107l.71.71-20.83 20.82zM242.4 127.53h1104.9v1H242.4z"
            fillRule="nonzero"
          />
          <g fillRule="nonzero">
            <path d="M29.51 132.56a4.514 4.514 0 0 1-4.171-2.801 4.521 4.521 0 0 1 5.927-5.888 4.524 4.524 0 0 1 2.774 4.189 4.532 4.532 0 0 1-4.53 4.5zm0-8a3.519 3.519 0 0 0-2.468 6.02 3.513 3.513 0 0 0 3.841.746 3.518 3.518 0 0 0 2.157-3.266 3.528 3.528 0 0 0-2.177-3.27 3.532 3.532 0 0 0-1.353-.27v.04zM1351.3 132.56c-.89 0-1.77-.266-2.51-.762a4.607 4.607 0 0 1-1.67-2.029 4.487 4.487 0 0 1-.25-2.611c.17-.877.6-1.682 1.23-2.315a4.528 4.528 0 0 1 6.96.685 4.51 4.51 0 0 1-.57 5.705 4.509 4.509 0 0 1-3.19 1.327zm0-8c-.7 0-1.38.206-1.96.593-.57.387-1.03.936-1.29 1.579a3.458 3.458 0 0 0-.2 2.034c.13.683.47 1.31.96 1.803a3.518 3.518 0 0 0 3.84.763 3.56 3.56 0 0 0 1.58-1.297 3.57 3.57 0 0 0 .59-1.955c0-.466-.08-.927-.26-1.358a3.4 3.4 0 0 0-.76-1.154 3.57 3.57 0 0 0-1.15-.774c-.42-.18-.88-.273-1.35-.274v.04zM241.4 132.05a4.02 4.02 0 1 0 0-8.04 4.02 4.02 0 0 0 0 8.04z" />
          </g>
          <text
            x={-1.391}
            y={174.416}
